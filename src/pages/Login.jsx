    ...
    <div className="min-h-screen bg-[#080c10] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm space-y-8 animate-fadeIn">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-white/40">Sign in to your analytics workspace</p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-[#0d1117]/80 backdrop-blur-sm p-8 shadow-2xl space-y-5">
          ...
          <p className="text-center text-xs text-white/30">
            ...
            <Link to="/register" className="text-[#63ffb4] hover:text-white transition-colors font-semibold">Create one</Link>
          </p>
        </div>
        <p className="text-center text-xs text-white/20">FounderBrain · Startup Intelligence Platform</p>
      </div>
    </div>
  );
}